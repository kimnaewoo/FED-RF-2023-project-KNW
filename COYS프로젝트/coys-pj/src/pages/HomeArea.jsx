    ...
    <section id="home-area" className="home-area">
      ...
      <div className="home">
        ...
        <div className="h-ex">
          ...
          <h2>
            Spurs Media Watch Today's media stories brought to you by NewsNow.<br/>These stories have been specially selected
            from today's media.<br/> They do not necessarily represent the views or position of Tottenham Hotspur Football
